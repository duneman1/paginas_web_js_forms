...
/* changeGenero () {
    if (this.generosFirst){
        this.aGeneros.shift() //Borra el primero del array.
        this.crearSelect() //refresca el array
        this.generosFirst = false //cambia el estado, porque sino borraria el primero todo el rato
    }
